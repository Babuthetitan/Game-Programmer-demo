...
#ifndef SteveGainFXParams_H
#define SteveGainFXParams_H
...
struct SteveGainRTPCParams
{
    AkReal32 fPlaceholder;
};

struct SteveGainNonRTPCParams
{
};

struct SteveGainFXParams
    : public AK::IAkPluginParam
{
    SteveGainFXParams();
    SteveGainFXParams(const SteveGainFXParams& in_rParams);
    ...
    SteveGainRTPCParams RTPC;
    SteveGainNonRTPCParams NonRTPC;
};

#endif // SteveGainFXParams_H
